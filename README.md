...
- 🏗️ **Backend Architecture** — Laravel, PHP 8.x, RESTful APIs, Microservices
- 🗄️ **Database Design** — MySQL, query optimization, complex reporting
...
- Role-based access (Admin, Legal Officer, Viewer) via Spatie
- Document vault with expiry tracking & compliance task manager
- Full audit trail and Chart.js reporting dashboard
- **Stack:** Laravel 11, MySQL, Bootstrap 5, Chart.js

---

## 📈 GitHub Stats

![Kashif's GitHub Stats](https://github-readme-stats.vercel.app/api?username=kashifali-laraveldev&show_icons=true&theme=dark&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=kashifali-laraveldev&layout=compact&theme=dark&hide_border=true)

---

## 🌍 Open For

- ✅ Remote freelance projects (International)
- ✅ Contract-based backend development
- ✅ Laravel API development & SaaS products
